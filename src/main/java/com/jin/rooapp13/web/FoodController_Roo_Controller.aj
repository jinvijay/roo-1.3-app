...
import com.jin.rooapp13.web.FoodController;
...
privileged aspect FoodController_Roo_Controller {
    ...
    public String FoodController.show(@PathVariable("id") BigDecimal id, Model uiModel) {
    ...
    public String FoodController.updateForm(@PathVariable("id") BigDecimal id, Model uiModel) {
        populateEditForm(uiModel, Food.findFood(id));
        return "foods/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String FoodController.delete(@PathVariable("id") BigDecimal id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
